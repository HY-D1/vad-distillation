...
Usage:
    python scripts/personal/run_my_experiment.py \
        --checkpoint outputs/quick_test/checkpoints/fold_F01_latest_best.pt \
        --manifest manifests/torgo_pilot.csv \
        --baseline-dir outputs/personal/baseline_energy_50/frame_probs \
        --output-dir outputs/personal/comparison
"""
...
def main():
    ...
    parser.add_argument(
        '--output-dir',
        type=str,
        default='outputs/personal/comparison',
