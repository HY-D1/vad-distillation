...
Usage:
    python scripts/personal/plot_model_vs_energy.py \
        ...
        --summary outputs/personal/comparison/summary.json \
        --manifest manifests/torgo_pilot.csv \
        --output-dir outputs/personal/qualitative_plots
"""
...
def main():
    ...
    parser.add_argument(
        '--output-dir',
        type=str,
        default='outputs/personal/qualitative_plots',
